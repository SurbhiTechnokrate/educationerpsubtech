          ...
          {timetable.map((item) => (
            ...
            >
              <div className="col-span-4 flex items-center min-w-0">
                ...
                <div
                  className={`border-l-4 ${item.borderColor} pl-2 font-medium text-slate-700 truncate text-[11px] sm:text-xs`}
                >
                  {item.time}
                </div>
              </div>
              ...
              <div className="col-span-2 text-slate-600 truncate" title={item.subject}>
                {item.subject}
              </div>

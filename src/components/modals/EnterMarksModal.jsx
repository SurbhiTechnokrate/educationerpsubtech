      ...
      <div className="bg-white rounded-3xl shadow-2xl max-w-3xl w-full border border-slate-200 overflow-hidden animate-fade-in flex flex-col max-h-[90vh]">
        ...
        <div className="p-4 sm:p-6 bg-slate-900 text-white flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-base sm:text-lg leading-tight">Exam Marks Entry</h3>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div>
              ...
              <select
                ...
                className="px-2.5 py-1.5 bg-white border border-slate-300 rounded-lg text-xs font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-purple-500 max-w-full"
              >
                {examOptions.map(opt => (
        ...
        {/* Spreadsheet Grid with Touch Scroll */}

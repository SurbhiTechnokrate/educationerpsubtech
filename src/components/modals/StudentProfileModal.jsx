        ...
        <div className="p-6 bg-slate-900 text-white relative">
          ...
          <div className="flex items-center gap-4">
            <img
              src={student.photo}
              alt={student.name}
              className="w-16 h-16 rounded-2xl object-cover border-2 border-white/20 shadow-md ring-4 ring-white/10"
            />
            <div>
              <div className="flex items-center gap-2">
                <h3 className="font-extrabold text-xl leading-tight">{student.name}</h3>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5">
          ...
          <div className="grid grid-cols-3 gap-3 text-center">
            <div className="p-3 bg-emerald-50 border border-emerald-100 rounded-2xl">
              ...
              <span className="block font-black text-lg text-emerald-700 mt-0.5">{student.attendance}</span>
            </div>
            <div className="p-3 bg-blue-50 border border-blue-100 rounded-2xl">
              ...
              <span className="block font-black text-lg text-blue-700 mt-0.5">{student.overallGrade}</span>
            </div>
            <div className={`p-3 rounded-2xl border ${
              ...
              <span className="block font-black text-lg mt-0.5">{student.feeStatus}</span>
            </div>
          </div>
          ...
          <div className="bg-slate-50 rounded-2xl p-4 border border-slate-200/80">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="bg-white p-2.5 rounded-xl border border-slate-200">
                <span className="text-[11px] text-slate-500 font-medium">Mathematics</span>
                <div className="text-base font-bold text-slate-900 mt-0.5">{student.mathScore}%</div>
              </div>
              <div className="bg-white p-2.5 rounded-xl border border-slate-200">
                <span className="text-[11px] text-slate-500 font-medium">Science</span>
                <div className="text-base font-bold text-slate-900 mt-0.5">{student.scienceScore}%</div>
              </div>
              <div className="bg-white p-2.5 rounded-xl border border-slate-200">
                <span className="text-[11px] text-slate-500 font-medium">English</span>
                <div className="text-base font-bold text-slate-900 mt-0.5">{student.englishScore}%</div>
              </div>
            </div>
          </div>

  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight">Announcements & Circulars</h2>
        ...
        <button
          onClick={() => addToast('Announcement creation modal ready.', 'info')}
        ...
        {announcements.map((item) => (
          ...
          >
            <div className="flex items-start gap-4">
              <span className={`w-3.5 h-3.5 rounded-full ${item.dotColor} mt-1.5 flex-shrink-0`} />
              <div>
                ...
                <div className="flex items-center gap-4 text-[11px] text-slate-400 mt-2 font-medium">
                  <span>Issued Date: {item.date}</span>
                  <span>•</span>

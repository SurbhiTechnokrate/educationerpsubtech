      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            <h2 className="text-xl sm:text-2xl font-extrabold text-slate-900 tracking-tight">Lesson Plans & Curriculum</h2>
        ...
        <button
          ...
          className="self-start sm:self-auto px-4 py-2 bg-rose-600 hover:bg-rose-700 text-white rounded-xl text-xs font-bold shadow-md shadow-rose-600/30 transition-all flex items-center gap-1.5"
        >
        ...
        {filteredPlans.map((plan) => (
          ...
          >
            <div>
              ...
              <h3 className="text-sm sm:text-base font-bold text-slate-900 mt-3">{plan.title}</h3>
            ...
            <div className="mt-4 sm:mt-5 pt-3 border-t border-slate-100 text-xs text-slate-500">

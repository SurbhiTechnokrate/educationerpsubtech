      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight">Study Materials & LMS</h2>
          ...
          >
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <h3 className="text-sm font-bold text-slate-900 mt-1">{mat.title}</h3>
                  </div>
                </div>
              </div>

              <div className="mt-4 flex items-center gap-4 text-xs text-slate-400 font-medium pt-3 border-t border-slate-100">
            ...
            <div className="mt-5 pt-3 border-t border-slate-100 flex items-center justify-between">
              <span className="text-xs text-slate-500 font-medium">
                📥 {mat.downloads} student downloads
              </span>
              <button

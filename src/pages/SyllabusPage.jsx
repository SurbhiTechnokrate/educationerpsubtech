      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight">Syllabus Tracker</h2>
        ...
        <div className="flex items-center gap-3">
          <div className="px-4 py-2 bg-emerald-50 text-emerald-700 font-extrabold rounded-2xl text-xs border border-emerald-200">
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden divide-y divide-slate-100">
        {activeChapters.map((ch) => (
          <div
            ...
            className="p-5 flex items-center justify-between gap-4 hover:bg-slate-50/80 cursor-pointer transition-colors"
          >
            <div className="flex items-center gap-3.5">
              {ch.status === 'Completed' ? (
                <CheckCircle2 className="w-5 h-5 text-emerald-500 flex-shrink-0" />
              ) : ch.status === 'In Progress' ? (
                <span className="w-5 h-5 rounded-full border-2 border-blue-500 flex items-center justify-center flex-shrink-0">
              ...
              <div>
                ...
                <div className="flex items-center gap-3 text-xs text-slate-400 mt-0.5">
                  ...
                  <span>•</span>
                  <span>Evaluation Weightage: {ch.examMarks} Marks</span>
                  <span>•</span>

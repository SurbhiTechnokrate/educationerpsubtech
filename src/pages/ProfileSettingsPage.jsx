...
export const ProfileSettingsPage = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      {/* Header */}
      <div>
        <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight">Faculty Profile & Settings</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4 bg-white rounded-3xl p-6 border border-slate-200 shadow-sm text-center">
          <img
            src={formData.avatar}
            alt={formData.name}
            className="w-28 h-28 rounded-full object-cover mx-auto border-4 border-slate-100 shadow-lg ring-4 ring-blue-500/20"
          />
          <h3 className="text-lg font-bold text-slate-900 mt-4">{formData.name}</h3>
          ...
          <div className="mt-6 pt-5 border-t border-slate-100 space-y-3 text-left text-xs text-slate-600">
        ...
        <div className="lg:col-span-8 bg-white rounded-3xl p-6 border border-slate-200 shadow-sm">
          <h3 className="font-bold text-base text-slate-900 pb-4 border-b border-slate-100 mb-5">
          ...
          <form onSubmit={handleSave} className="space-y-4 text-xs">
            ...
            <div className="pt-4 border-t border-slate-100 flex items-center justify-end">
              <button
                type="submit"
                className="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-md shadow-blue-600/30 transition-all flex items-center gap-2"
              >
